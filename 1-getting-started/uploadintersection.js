export function uploadintersection(){
    cy.wait(9000)
...
cy.wait(5000)
 ...
 cy.get('div#content li.pb-1').click()
 //click on overwrite
 cy.get('div#content div.button.borderRight > button').click()
 


 cy.get('input#Import-mdl-fileUpload').selectFile('cypress/fixtures/food_hierarchy.csv') //attach Intersection file
 cy.wait(5000)
